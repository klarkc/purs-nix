    ...
    utils.lib.eachDefaultSystem
      (system:
         let
           ...
           node_modules = p.runCommand "node_modules" {}
             ''
               mkdir -p $out/my-class
               echo "export default class MyClass {};" > $out/my-class/index.js
               echo "{\"type\": \"module\"}" > $out/my-class/package.json
             '';
           ...
           ps =
             purs-nix.purs
               { dependencies =
                 ...
                 foreign."Main" = { inherit node_modules; };
                 foreign."Alt" = { inherit node_modules; };
               };
         in
         rec
         { apps.default =
